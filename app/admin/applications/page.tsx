  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row items-center mb-4 gap-4">
        ...
        <div className="flex items-center gap-2">
          <label htmlFor="user-filter" className="text-sm font-medium">申請者:</label>
          <Select value={filterByUser || "all"} onValueChange={(value) => setFilterByUser(value === "all" ? "" : value)}>
            <SelectTrigger id="user-filter" className="w-[200px]"><SelectValue placeholder="すべて" /></SelectTrigger>
            <SelectContent>
              <SelectItem value="all">すべて</SelectItem>
